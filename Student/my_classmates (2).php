	...
	<?php include('my_classmates_link.php'); ?>
            <section class="main_contant" id="main_contant">
            	 <div class="container-fluid">
					...
					?>
					     <ul class="breadcrumb">
							<a href="#" style="color:black;"><?php echo $row['class_name']; ?></a> <span class="divider" style="color:black;">/</span></li>
							<a href="#" style="color:black;"><?php echo $row['subject_code']; ?></a> <span class="divider">/</span>
							<a href="#" style="color:black;">School Year: <?php echo $row['school_year']; ?></a> <span class="divider">/</span>
							<a href="#" style="color:black;"><b>My Classmates</b></a>
						</ul>
